...
The data used in this project is provided under the terms of the [Divvy Bikes Data License Agreement](https://divvybikes.com/data-license-agreement). A sample of the data used in this analysis is available [here](https://github.com/Data-cat750/analytics-portfolio/blob/main/Cyclistic/data.csv). This data is used for non-commercial, analytical purposes in compliance with the terms of the License Agreement.
